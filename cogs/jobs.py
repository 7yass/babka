...
JOBS = {
    ...
    'sprzatacz': {'label': 'Sprzątacz', 'base': (30, 55), 'min_level': 0,
                  'track': ['Praktykant', 'Mopiarz', 'Sprzątacz', 'Starszy Sprzątacz', 'Brygadzista',
                            'Kierownik Czystości', 'Inspektor', 'Manager Obiektu', 'Ekspert Higieny', 'Legenda Mopa'],
                  'house_title': 'Właściciel Firmy Sprzątającej',
                  'shifts': ['myłeś okna na 10 piętrze', 'odkurzałeś open space po imprezie',
                             'szarowałeś podłogę do połysku', 'wywoziłeś worki w deszczu']},
    'farmer': {'label': 'Farmer', 'base': (60, 105), 'min_level': 2,
               'track': ['Pomocnik', 'Parobek', 'Farmer', 'Gospodarz', 'Starszy Gospodarz',
                         'Sołtys', 'Plantator', 'Hodowca', 'Agrobiznesmen', 'Legenda Pól'],
               'house_title': 'Właściciel Folwarku',
               'shifts': ['doiłeś krowy o 5 rano', 'zbierałeś ziemniaki w błocie',
                          'naprawiałeś traktor w polu', 'sprzedawałeś jajka na targu']},
    'nauczyciel': {'label': 'Nauczyciel', 'base': (180, 320), 'min_level': 9,
                   'track': ['Stażyściak', 'Belfer', 'Nauczyciel', 'Wychowawca', 'Starszy Nauczyciel',
                             'Egzaminator', 'Dyrektor Szkoły', 'Kurator', 'Minister Edukacji', 'Legenda Tablicy'],
                   'house_title': 'Założyciel Szkoły',
                   'shifts': ['sprawdzałeś klasówki do północy', 'uspokajałeś 3b po przerwie',
                              'prowadziłeś wywiadówkę w ogniu pytań', 'układałeś plan lekcji']},
    'policjant': {'label': 'Policjant', 'base': (320, 480), 'min_level': 14,
                  'track': ['Kursant', 'Posterunkowy', 'Policjant', 'Starszy Posterunkowy',
                            'Sierżant', 'Komisarz', 'Nadkomisarz', 'Inspektor', 'Generał', 'Legenda Patrolu'],
                  'house_title': 'Komendant Główny',
                  'shifts': ['goniłeś złodzieja rowerów', 'stałeś na blokadzie całą noc',
                             'wypisywałeś mandaty na mieście', 'prowadziłeś pościg radiowozem']},
    'pilot': {'label': 'Pilot', 'base': (600, 900), 'min_level': 22,
              'track': ['Uczeń Pilota', 'Drugi Pilot', 'Pilot', 'Kapitan', 'Starszy Kapitan',
                        'Instruktor', 'Pilot Testowy', 'Szef Pilotów', 'As Przestworzy', 'Legenda Nieba'],
              'house_title': 'Właściciel Linii Lotniczych',
              'shifts': ['lądowałeś w burzy nad Balicami', 'leciałeś red-eye do Nowego Jorku',
                         'ogarniałeś turbulencje z uśmiechem', 'tankowałeś przed długim haul']},
    'naukowiec': {'label': 'Naukowiec', 'base': (750, 1100), 'min_level': 28,
                  'track': ['Laborant', 'Asystent', 'Naukowiec', 'Badacz', 'Starszy Badacz',
                            'Doktor', 'Profesor', 'Dyrektor Instytutu', 'Noblista', 'Legenda Nauki'],
                  'house_title': 'Założyciel Instytutu',
                  'shifts': ['mieszałeś probówki do 3 nad ranem', 'publikowałeś paper z przełomem',
                             'broniłeś grantu przed komisją', 'odkrywałeś pierwiastek w Excelu']},
    'astronauta': {'label': 'Astronauta', 'base': (1000, 1500), 'min_level': 35,
                   'track': ['Kandydat', 'Rezerwowy', 'Astronauta', 'Specjalista Misji', 'Dowódca Misji',
                             'Weteran ISS', 'Instruktor Kosmiczny', 'Szef Programu', 'Marsjanin', 'Legenda Kosmosu'],
                   'house_title': 'Właściciel Agencji Kosmicznej',
                   'shifts': ['robiłeś spacer kosmiczny 6h', 'dokowałeś do ISS ręcznie',
                              'jadłeś liofilizowane lody', 'trenowałeś w wirówce do wymiotów']},
    'prezydent': {'label': 'Prezydent', 'base': (1300, 2000), 'min_level': 45,
                  'track': ['Radny', 'Burmistrz', 'Poseł', 'Senator', 'Marszałek',
                            'Premier', 'Wiceprezydent', 'Prezydent', 'Mąż Stanu', 'Legenda Narodu'],
                  'house_title': 'Ojciec Narodu',
                  'shifts': ['podpisywałeś ustawy stosem', 'leciałeś na szczyt klimatyczny',
                             'ucinałeś wstęgi w trzech miastach', 'debatowałeś do białego rana']},
